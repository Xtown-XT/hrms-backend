...
// supports: includeInactive, search, page, limit, orderBy, order
export const getAllShifts = async (req, res) => {
  try {
    const options = {
      query: req.query,
      // adjust these searchable fields if your model uses different names
    ...
    return res.status(200).json({
      ...
      ...result, // expected { rows, count, page, limit } or service-specific shape
    });
  } catch (error) {
